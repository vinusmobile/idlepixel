...
-(void)setHighlighted:(BOOL)highlighted animated:(BOOL)animated
{
    ...
    [self executeSelectedHighlightedBlock:self.selected highlighted:highlighted animated:animated];
}

-(void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    [super setSelected:selected animated:animated];
    [self executeSelectedHighlightedBlock:selected highlighted:self.highlighted animated:animated];
}
